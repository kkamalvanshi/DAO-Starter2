...
const App = () => {
  ...
  //combining memberAddresses and memberTokenAmounts into single array
    ...
    const checkBalance = async () => {
      try {
        ...
        if(balance.gt(0)) {
          ...
          console.log("This user doesn't have membership NFT")
        }
      } catch (error) {
        setHasClaimedNFT(false);
  ...
  const mintNFT = async () => {
    try {
      ...
      console.log(`Successfully minted! OpenSea Link: https://testnets.opensea.io/assets/${editionDrop.getAddress()}/0`);
      setHasClaimedNFT(true);
    } catch (error) {
      setHasClaimedNFT(false);
  ...
  if(address && (network?.[0].data.chain.id != ChainId.Rinkeby)) {
    return (
      <div className="unsupported-network">
        <h2>Plase connect to Rinkeby</h2>
        <p>This dapp only uses rinkeby
        </p>
      </div>
    )
  }
